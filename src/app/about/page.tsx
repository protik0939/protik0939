            ...
            >
                <div className="max-w-4xl mx-auto p-6 shadow-md rounded-lg my-10">
                    <header className="text-center mb-8">
                        <h1 className="text-4xl font-bold text-white">Discovering My Path: A Journey of Growth and Ambition</h1>
                        <p className="font-bold text-white mt-2">By Protik</p>
                    </header>
                    ...
                    <section className="mb-8">
                        <h2 className="text-3xl font-semibold text-white mb-4">Early Beginnings and Educational Background</h2>
                        <p className="text-lg text-white mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-3xl font-semibold text-white mb-4">Pursuing Computer Science</h2>
                        <p className="text-lg text-white mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-3xl font-semibold text-white mb-4">Skills and Competencies</h2>
                        <p className="text-lg text-white mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-3xl font-semibold text-white mb-4">Challenges and Growth</h2>
                        <p className="text-lg text-white mb-4">
                    ...
                    <section className="mb-8">
                        <h2 className="text-3xl font-semibold text-white mb-4">Future Goals</h2>
                        <p className="text-lg text-white mb-4">
